            ...
            <section class="gl-zone gl-zone--pinned-hubs" data-zone="pinned_hubs">
                <div class="gl-container">
                    ...
                    <div class="gl-card-grid gl-card-grid--3col">
                        ...
                        <a href="<?php echo esc_url( get_permalink( $hub->ID ) ); ?>" class="gl-hub-card" style="--cat-accent: <?php echo esc_attr( $category_color ); ?>">
            ...
            <div class="gl-zone gl-zone--filter-bar" data-zone="filter_bar">
                <div class="gl-container">
                    <div class="gl-archive-filters">
                        <a href="<?php echo esc_url( get_category_link( $category->term_id ) ); ?>" class="gl-hub-filter gl-hub-filter--active"><?php esc_html_e( 'All', 'gtalobby' ); ?></a>
                        <?php foreach ( gtalobby_get_post_types() as $pt_slug ) :
                            $pt_obj = get_post_type_object( $pt_slug );
                            if ( ! $pt_obj ) continue;
                        ?>
                        <a href="<?php echo esc_url( add_query_arg( 'post_type', $pt_slug, get_category_link( $category->term_id ) ) ); ?>" class="gl-hub-filter">
